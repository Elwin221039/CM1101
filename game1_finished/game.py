...
def normalise_input(user_input):
    ...
    #print("lower", str.lower(user_input))
...
def exit_leads_to(exits, direction):
    ...
    'Reception'
    """
    #({'south': 'Admins', 'east': 'Tutor', 'west': 'Parking'}, 'south')
    Temp = exits[direction]
    Result = rooms[Temp]
    return Result["name"]
...
def print_menu(exits):
    ...
    print("You can:")
    for char in exits:
        #print(char, exits[char]) --- Result = south admin
        Taken = rooms[exits[char]]
        TakenResult = (Taken["name"])
        print_menu_line(char, TakenResult)
        #Taken  = rooms(exits[char])
